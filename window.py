...
def create_window_content(window, content_type):
    ...
    if content_type == "game_settings":
        ...
        easy_button = Button(window, bg=easy_button_color, fg=easy_button_font_color, width=easy_button_width, height=easy_button_height, text=easy_button_text, font='sans 16 bold', activebackground=easy_button_active_color, activeforeground=easy_button_font_active_color)
        normal_button = Button(window, bg=normal_button_color, fg=normal_button_font_color, width=normal_button_width, height=normal_button_height, text=normal_button_text, font='sans 16 bold', activebackground=normal_button_active_color, activeforeground=normal_button_font_active_color)
        hard_button = Button(window, bg=hard_button_color, fg=hard_button_font_color, width=hard_button_width, height=hard_button_height, text=hard_button_text, font='sans 16 bold', activebackground=hard_button_active_color, activeforeground=hard_button_font_active_color)
